...
<div class="adminHeader">
	<div class="row">
		<div class="navbar-header col-sm-4  mynav_c">
			<a class="main m1" href="${pageContext.request.contextPath}/hi/admin_movie/adminMovie.hi">MOVING</a>
		</div>
		<div class="col-sm-8 row">
			<div class="col-sm-2"><a class="btn" href="${pageContext.request.contextPath}/hi/admin_movie/adminMovie.hi">영    화</a></div>
			<div class="col-sm-2"><a class="btn" href="${pageContext.request.contextPath}/hj/theaterlist.hj">영 화 관</a></div>
